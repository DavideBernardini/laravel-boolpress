...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $newCategory->save();
        // redirect
        return redirect()->route("admin.categories.index")->with("success", "category \"{$newCategory->name}\" created");
    }
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect()->route("admin.categories.index")->with("success", "Category \"{$category->name}\" is updated");
    }
